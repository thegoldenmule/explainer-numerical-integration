...
Built. See `design/idea.md` (section "12. Higher-order Runge-Kutta") for the beat, and
`design/plan.md` for the pane contract. Panel 12 is the one exception to "side panes are one
